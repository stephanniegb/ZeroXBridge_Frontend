...
>
  ...
  />
  <span className="font-medium text-[1.125rem] w-12 text-center">{fromToken}</span> {/* Fixed width */}
  <ChevronDown size={16} className="ml-1 flex-shrink-0" />
        ...
        <div className="flex items-center gap-x-1">
            ...
            <p className="text-[0.75rem] text-[#888888] ">7.04 <span className="text-white font-bold">MAX</span></p>
        </div>
      </div>
...
>
  <Image
    ...
    className="w-[24px] h-[24px] object-contain mr-2"
  />
  <span className="font-medium text-[1.125rem] w-12 text-center">{toToken}</span> {/* Fixed width */}
  <ChevronDown size={16} className="ml-1 flex-shrink-0" />
</button>
